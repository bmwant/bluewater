...
\begin{document}
\begin{flushright}
\raisebox{-\baselineskip}{\shortstack{\underline{\hspace{1cm}Бегерський Михайло Васильович\hspace{1cm}}\\
(\textit{прізвище, ім'я, по батькові студента})}}
\end{flushright}
...
\newpage
\begin{flushright}
\raisebox{-\baselineskip}{\shortstack{\underline{\hspace{1cm}Misha Behersky\hspace{1cm}}\\
(\textit{student first name, last name})}}
\end{flushright}
...
Студент(ка) \raisebox{-\baselineskip}{\shortstack{\underline{\hspace{3cm}}\\(\textit{підпис})}}
\raisebox{-\baselineskip}{\shortstack{\underline{\hspace{7cm}}\\(\textit{прізвище, ім'я, по батькові})}}
